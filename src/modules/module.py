...
class AutomationM(Module) : # ! not tested
    """
...
class MachineLM(Module): # ! not tested
...
class DeepLM(Module): # ! not tested
...
__all__ = ["Module","WebM","AutomationM","MachineLM","DeepLM","LossFunction"]
